...
<main class="contenedor sombra">
    ...
    <div class="formulario__requisicion">
        <form action="/armonizacion_contable/add_requisicion.php" method="POST">
            ...
            <div class="field">
                ...
                <select class="selected" name="solicita_req" require>
                    <option value="">Seleccione una opción</option>
                    <?php
            ...
            <div class="field">
                ...
                <select class="selected" name="revisa_req" require>
                    <option value="">Seleccione una opción</option>
                    <?php
            ...
            <div class="field">
                ...
                <select class="selected" name="autoriza_req" require>
                    <option value="">Seleccione una opción</option>
                    <?php
